...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // Membuat objek dari kelas TextEditingController untuk field nim, nama, prodi, dan semester
...
final semesterController = TextEditingController();
  ...
  // Method untuk menampilkan data ke dalam alert dialog
  void showData() {
    showDialog(
      context: context,
  ...
  // Method untuk memvalidasi input dan menampilkan data jika valid
  void validateInput() {
    ...
    if (form!.validate()) {
      ...
      // Memanggil method showData() untuk menampilkan data
      showData();
    }
  }
      ...
      body: Container(
        ...
        child: Form(
          ...
          child: Column(
            children: <Widget>[
              TextFormField(
                controller: nimController, // Mengaitkan controller nim
              ...
              TextFormField(
                controller: namaController, // Mengaitkan controller nama
                decoration: const InputDecoration(
                  hintText: 'Nama',
                  labelText: 'Nama',
              ...
              const SizedBox(height: 10.0),
              TextFormField(
                controller: prodiController, // Mengaitkan controller prodi
                decoration: const InputDecoration(
              ...
              const SizedBox(height: 10.0),
              TextFormField(
                controller: semesterController, // Mengaitkan controller semester
                decoration: const InputDecoration(
                  hintText: 'Semester',
                  labelText: 'Semester',
